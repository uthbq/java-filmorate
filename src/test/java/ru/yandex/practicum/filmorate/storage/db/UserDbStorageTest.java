...
public class UserDbStorageTest {
    ...
    void shouldCreate() {
        ...
        assertThat(users.get(0)).hasFieldOrPropertyWithValue("login", "georgelogin");
    }
    ...
    void shouldGetAll() {
        ...
        assertThat(users.get(1)).hasFieldOrProperty("birthday");
        assertThat(users.get(1)).hasFieldOrPropertyWithValue("login", "georgelogin2");
    }
    ...
    void shouldGetUserById() {
        ...
        assertThat(user).hasFieldOrPropertyWithValue("login", "georgelogin2");
    }
    ...
    void shouldAddToFriendsAndGetUserFriends() {
        ...
        assertThat(friendsList.get(0)).hasFieldOrPropertyWithValue("login", "georgelogin2");
    }
